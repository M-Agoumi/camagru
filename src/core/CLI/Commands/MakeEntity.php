...
class MakeEntity
{
	...
	private function createEntityCLassFile(string $entityName, string $entityTable, array $entityComponents)
	{
		...
		$templateFileName = CLIApplication::$app->root . '/views/commands/templates/entity.template';
		...
		if (file_put_contents(CLIApplication::$app->root. "/src/models/" . $entityName . ".php", $template))
